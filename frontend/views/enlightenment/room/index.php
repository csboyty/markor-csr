...
?>
<div class="pageTop">
    <img class="image" src="images/app/pageTop/artRoom.jpg" srcset="images/app/pageTop/artRoom@2x.jpg 2x">
    <div class="info">
...
<div class="section">
    ...
    <a class="more" href="activities/<?= Yii::$app->params["categories"]["activityRoom"]; ?>">更多</a>
</div>
