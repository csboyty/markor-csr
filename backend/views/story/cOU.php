...
<form class="form-horizontal" id="myForm" action="post/submit" method="post">
    ...
    ?>
    <input type="hidden" value="<?php echo Yii::$app->params["categories"]["story"]; ?>" name="category_id">
    ...
    <div class="form-group">
        <label  class="control-label col-md-2">人物*</label>
        <div class="col-md-8">
...
<?php
    ...
    $this->registerJsFile("@web/js/src/storyCOU.js",['depends' => [backend\assets\AppAsset::className()]]);
?>